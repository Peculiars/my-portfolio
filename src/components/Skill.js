  ...
  return (
    <>
        ...
        <div className='relative w-full h-screen flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark'>
            <motion.div className='flex items-center justify-center bg-dark dark:bg-light dark:text-dark text-light font-semibold rounded-full shadow-dark p-5 cursor-pointer' whileHover={{scale: 1.1}}>
                web
            </motion.div>
