...
export const FeaturedProjects=({type, title, summary, img, link, github})=>{
    return(
      <article className='relative w-full flex items-center justify-between rounded-3xl border-2 border-dark dark:border-light p-12 bg-light shadow-2xl dark:bg-dark'>
        ...
        <div className='w-1/2 flex flex-col items-start justify-between pl-6'>
          ...
          <Link className='hover:underline underline-offset-2' href={link} target='_blank'>
            <h2 className='my-2 w-full text-4xl text-left font-bold dark:text-light'>{title}</h2>
          </Link>
