...
export const HireMe = () => {
  return (
    <div className='xs:absolute xs:right-5 xs:top-2 xl:top-[35rem] 2xl:top-[33rem] flex items-center overflow-hidden'>
        <div className='xs:w-28 h-auto flex items-center justify-center relative'>
